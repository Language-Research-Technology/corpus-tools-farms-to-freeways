...
BASE_DATA_DIR=/Users/moises/cloudstor/Shared
...
TEMPLATE_DIR=${BASE_DATA_DIR}/atap-repo-misc/farms_to_freeways
DATA_DIR=${BASE_DATA_DIR}/atap-repo-misc/farms_to_freeways_csv_files
